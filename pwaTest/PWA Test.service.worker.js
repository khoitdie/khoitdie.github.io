...
/** @type {string} */
const CACHE_VERSION = '1758040387|927066720';
/** @type {string} */
const CACHE_PREFIX = 'PWA Test-sw-cache-';
...
/** @type {string[]} */
const CACHED_FILES = ["PWA Test.html","PWA Test.js","PWA Test.offline.html","PWA Test.icon.png","PWA Test.apple-touch-icon.png","PWA Test.audio.worklet.js","PWA Test.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["PWA Test.wasm","PWA Test.pck"];
